  ...
  <div class="app-container">
    <div class="filter-container" style="display:flex;justify-content:space-between;">
      ...
      <div>
        ...
        <el-input v-model="listQuery.title" placeholder="Title" style="width: 200px; margin-left: 10px;"
      ...
      <el-table-column label="内容" min-width="180px">
        <template slot-scope="{row}">
          <div style="display: flex;">
            <img src="../../assets/401_images/401.gif" style="width:100px; height:50px; margin-right:10px;" >
            <div style="display: flex; flex-direction: column; justify-content: space-between;">
              <span>JavaEE课程设计</span>
