<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="更新状态" class-name="status-col" width="100">
        <template slot-scope="{ row }">
          <el-tag :type="row.isSend ? '已完结' : '连载中'">
            <span>{{ row.isSend ? "已完结" : "连载中" }}</span>
          </el-tag>
        </template>
      </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="更新状态">
          <el-radio-group v-model="temp.isSend">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        content: [{ required: true, message: "课程不能为空", trigger: "blur" }],
      },
